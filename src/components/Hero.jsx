  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      ...
      flex-row items-start gap-5`}>
        ...
        items-center mt-5">
          <div className="w-5 h-5 rounded-full bg-[#7BB3F2]"/>
          <div className="w-1 sm:h-80 h-40 violet-gradient"/>
        </div>

        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span
          className="text-[#7BB3F2]"> Kevin Montero</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
          Systems engineer with experience in creating <br className='sm:block hidden'/> 
