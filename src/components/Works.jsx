    ...
    index * 0.5, 0.75)}>
      ...
      sm:w-[360px] w-full">
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 text-secondart txt-[14px]">{description}</p>
        </div>
...
const Works = () => {
  return (
    ...
    <div className="w-full flex">
      ...
      through real examples of my work. Each project is briefly 
    ...
    <div className="mt-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
